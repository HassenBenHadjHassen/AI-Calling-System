				...
				<Card>
					...
					<CardContent>
						<div className="text-2xl font-bold">
							{callStats.totalCalls.toLocaleString()}
						</div>
				...
				<Card>
					...
					<CardContent>
						<div className="text-2xl font-bold text-green-600">
							{callStats.completedCalls.toLocaleString()}
						</div>
				...
				<Card>
					...
					<CardContent>
						<div className="text-2xl font-bold text-yellow-600">
							{callStats.transferredCalls.toLocaleString()}
						</div>
						<p className="text-xs text-muted-foreground">
					...
					<CardContent className="space-y-4">
						<div className="space-y-2">
							<div className="flex justify-between text-sm">
								...
								<span>
									{callStats.completedCalls} ({successRate.toFixed(1)}%)
								</span>
							</div>
						...
						<div className="space-y-2">
							<div className="flex justify-between text-sm">
								...
								<span>
									{callStats.transferredCalls} ({transferRate.toFixed(1)}%)
								</span>
							</div>
						...
						<div className="space-y-2">
							<div className="flex justify-between text-sm">
								...
								<span>
									...
									{(
										(callStats.failedCalls / callStats.totalCalls) * 100 || 0
									).toFixed(1)}
									%)
								</span>
							</div>
					...
					<CardContent className="space-y-4">
						...
						<div className="flex items-center space-x-2">
							...
							<div>
								...
								<p className="text-2xl font-bold">{callStats.initiatedCalls}</p>
							</div>
						</div>
